...
const AddMeasurement = () => {
    ...
    const handleAdd = (e) => {
        ...
        UserService.addMeasurement(data).then(
            () => {
                setLoading(false);
                toast.success("Vücut analiziniz başarıyla kaydedildi! 🚀");
                navigate("/home");
            },
            (error) => {
                toast.error(error);
        ...
        <div className="container d-flex align-items-center justify-content-center"
            ...
            <div className="card shadow-lg border-0 rounded-4 p-4" style={{maxWidth: "600px", width: "100%"}}>
                ...
                <div className="text-center mb-4">
                    <span style={{fontSize: "3rem"}} role="img" aria-label="ruler">📏</span>
                            ...
                            <div className="col-md-6">
                                <div className="form-floating mb-3">
                                    <input type="number" step="0.1" className="form-control bg-light border-0 rounded-3"
                                           id="kiloInput" placeholder="kg" value={kilo}
                                           onChange={(e) => setKilo(e.target.value)} required/>
                            ...
                            <div className="col-md-6">
                                <div className="form-floating mb-3">
                                    <input type="number" step="1" className="form-control bg-light border-0 rounded-3"
                                           id="boyInput" placeholder="cm" value={boy}
                                           onChange={(e) => setBoy(e.target.value)} required/>
                            ...
                            <div className="col-md-6">
                                <div className="form-floating mb-3">
                                    <input type="number" className="form-control bg-light border-0 rounded-3"
                                           id="yasInput" placeholder="Yaş" value={yas}
                                           onChange={(e) => setYas(e.target.value)} required/>
                            ...
                            <button className="btn btn-primary btn-lg rounded-pill fw-bold shadow-sm"
                                ...
                                {loading ? (
                                    <>
                                        ...
                                        Hesaplanıyor ve Kaydediliyor...
                                    </>
                                ) : "Analizi Kaydet"}
                            </button>
                            <button type="button" onClick={() => navigate("/home")}
                                    className="btn btn-light btn-lg rounded-pill text-muted" disabled={loading}>
                                İptal
                            </button>
                        </div>
